        ...
        <div className="flex justify-between">
          <div className="flex space-x-7">
            ...
            <div className="hidden md:flex items-center space-x-1">
              <Link to="/" className="py-4 px-2 text-gray-500  hover:active:text-green-500  hover:active:border-b-4 border-green-500 font-semibold transition duration-300 ">Home</Link>
              <Link to="/shop" className="py-4 px-2 text-gray-500 font-semibold hover:active:text-green-500 hover:active:border-b-4 border-green-500 transition duration-300">Shop</Link>
              <Link to="/about" className="py-4 px-2 text-gray-500 font-semibold hover:active:text-green-500  hover:active:border-b-4 border-green-500 transition duration-300">About</Link>
              <Link to="/contact" className="py-4 px-2 text-gray-500 font-semibold hover:active:text-green-500  hover:active:border-b-4 border-green-500 transition duration-300">Contact</Link>
              <Link to="/product" className="py-4 px-2 text-gray-500 font-semibold hover:active:text-green-500  hover:active:border-b-4 border-green-500 transition duration-300">Product</Link>
            </div>
          </div>
